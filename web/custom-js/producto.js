...
function enviar_frm()
{
  ...
  var id = $("#txtID").val();
  var codigo_interno =$("#txtCodigo").val();
  ...
  var dataString = 'proceso=' + proceso + '&id=' + id + '&codigo_interno=' + codigo_interno + '&codigo_barra=' + codigo_barra + '&nombre_producto=' + nombre_producto + '&precio_compra=' + precio_compra;
