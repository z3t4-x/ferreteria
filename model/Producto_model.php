<?php
	...
	class ProductoModel extends Conexion
	{
		...
		public function Insertar_Producto($codigo_interno,$codigo_barra,$nombre_producto,$precio_compra,$precio_venta,
		$precio_venta_mayoreo,$precio_venta_3,$stock,$stock_min,$idcategoria,$idmarca,$idpresentacion,$exento,$inventariable,$perecedero)
		{
			$dbconec = Conexion::Conectar();
			try
			{
				$query = "CALL sp_insert_producto(:codigo_interno,:codigo_barra,:nombre_producto,:precio_compra,:precio_venta,
				:precio_venta_mayoreo,:precio_venta_3,:stock,:stock_min,:idcategoria,:idmarca,:idpresentacion,:exento,:inventariable,:perecedero)";
				$stmt = $dbconec->prepare($query);
		...
		public function Editar_Producto($idproducto,$codigo_interno, $codigo_barra,$nombre_producto,$precio_compra,$precio_venta,$precio_venta_mayoreo,$precio_venta_3,$stock_min,
		$idcategoria,$idmarca,$idpresentacion,$estado,$exento,$inventariable,$perecedero)
		{
			$dbconec = Conexion::Conectar();
			try
			{
				$query = "CALL sp_update_producto(:idproducto,:codigo_interno,:codigo_barra,:nombre_producto,:precio_compra,:precio_venta,:precio_venta_mayoreo,:precio_venta_3,:stock_min,
				:idcategoria,:idmarca,:idpresentacion,:estado,:exento,:inventariable,:perecedero);";
				$stmt = $dbconec->prepare($query);
				$stmt->bindParam(":idproducto",$idproducto);
				$stmt->bindParam(":codigo_interno", $codigo_interno);
